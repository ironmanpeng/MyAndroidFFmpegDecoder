...
#include <jni.h>
/* Header for class com_pengtg_myandroidffmpegdecoder_Mp3Decoder */

#ifndef _Included_com_pengtg_myandroidffmpegdecoder_Mp3Decoder
#define _Included_com_pengtg_myandroidffmpegdecoder_Mp3Decoder
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_pengtg_myandroidffmpegdecoder_Mp3Decoder
 * Method:    init
